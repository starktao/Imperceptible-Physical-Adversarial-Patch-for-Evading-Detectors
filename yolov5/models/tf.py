...
Usage:
    $ python models/tf.py --weights yolov5s_pertrain.pth

Export:
    $ python export.py --weights yolov5s_pertrain.pth --include saved_model pb tflite tfjs
"""
...
def run(
    weights=ROOT / "yolov5s_pertrain.pth",  # weights path
...
def parse_opt():
    ...
    parser.add_argument("--weights", type=str, default=ROOT / "yolov5s_pertrain.pth", help="weights path")
